...
import s3 from '../assets/images/greater.png'
...
const Home = () => {
  ...
  return (
    ...
    <div className='items-center'>
      <img src={image} alt="MSD" className='w-48 h-48 mt-24 items mx-auto'></img>
    </div>
    <div className='button-container buttons'>
    <button className='b1' onClick={prevImage}>
        <img src={s3} className='w-8 h-8'></img>
      </button>
  ...
  <h2 className='text-center mt-36 text-3xl'>WELCOME TO Logistic PACKERS AND MOVER TRUSTED & PROFESSIONAL</h2>
  <div className='mt-8'>
        <div className='lg:grid grid-cols-2 mb-8 '>
        <img src={s1} alt='first' className='h-96 ml-44 second'></img>
